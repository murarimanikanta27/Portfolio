...
export const About: React.FC = () => {
  const skills = [
    ...
    'REST APIs', 'Express.js', 'Bootstrap', 'Git', 'GitHub', 'MySQL','Operating Systems', 'Data Structures', 'Algorithms', 'IoT', 'Arduino', 'ESP32', 'Web Development', 'Full Stack Development', 'Problem Solving',
  ];
  ...
  for solving algorithmic challenges.
          ...
          >
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-gray-300"> Skilled in Data Structures & Algorithms (DSA) and SQL for efficient and optimized solutions. <br />Full-stack developer , JavaScript, React, Node.js, PostgreSQL.</p>
            </div>
...
<Satellite className="text-yellow-500 mr-3" size={24} />
  ...
  <p className="text-gray-300">
   I will be doing tech tutorials and sharing my DIY projects to help others learn.
  </p>
</div>
